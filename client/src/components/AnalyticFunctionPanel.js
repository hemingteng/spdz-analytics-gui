...
`
const DivFuncDetail = DisplayBox.extend`padding: 0px 1px 2px 1px;`
...
`
const TdMainSub = TdMain.extend`padding: 0;`
const TdDetail = TdMain.extend`padding: 0 0 0 6px;`
const TdLabel = styled.td`
  ...
  border: none;
`
const DivFuncExample = DivFuncDetail.extend`padding: 6px;`
const PQueryLabel = styled.p`color: #888;`
const ThLabel = TdLabel.extend`text-align: left;`
...
const AnalyticFunctionPanel = props => {
  ...
  const selectableFunctionNames = props.functionNames.map(name =>
    <SelectableFunction
      ...
      functionName={name}
      changeSelected={props.chooseFunction}
    />
  )
        ...
        <Row>
              ...
              <TableMain>
                <tbody>
                  <tr>
                    ...
                    <TdMain>
                      {props.selectedFunction !== undefined
          ...
          <Col md={5}>
            <DivFuncExample>
              ...
              <CodeStyled>
                {props.selectedFunction !== undefined
                  ? props.selectedFunction.example
                  : 'Select an analytic function.'}
              </CodeStyled>
            </DivFuncExample>
          </Col>
        </Row>
